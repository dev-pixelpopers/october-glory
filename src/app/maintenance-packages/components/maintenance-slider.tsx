...
// PLACEHOLDER: still pointing at the bridal slider assets, since no
// maintenance-package imagery exists yet. Swap the paths and alt text once
// the real photos are in /public/images.
const slides = [
...
export default function MaintenanceSlider() {
