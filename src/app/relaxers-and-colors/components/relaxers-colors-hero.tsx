...
export default function RelaxersColorsHero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center flex flex-col items-center px-6">
        ...
        >
          Transform your look with our professional relaxer and coloring
          services — expertly formulated to deliver smooth, vibrant, and
