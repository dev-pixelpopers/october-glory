    ...
    >
      ...
      <div className="flex justify-center">
        <a
          ...
          style={{ opacity: 0 }}
        >
          <span className="w-[55px] h-[55px] rounded-full border border-[#1B1B1B] flex items-center justify-center text-[#1B1B1B] group-hover/btn:bg-[#ccb884] group-hover/btn:border-[#ccb884] group-hover/btn:text-white transition-all duration-300">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
          ...
          <span className="gotham text-[#1B1B1B] text-[20px] group-hover/btn:text-[#9C6D51] transition-colors duration-300">
