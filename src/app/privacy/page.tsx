...
export default function PrivacyPolicyPage() {
  return (
    <div className="main-app bg-[#1B1B1B] min-h-screen text-white flex flex-col relative">
      ...
      ============================ */}
      <section
        className="relative pt-[clamp(140px,120.58px_+_5.178vw,220px)] pb-[var(--space-section-y)] px-[var(--space-section-x)] bg-cover bg-center flex flex-col items-center justify-center text-center overflow-hidden"
        style={{ backgroundImage: "url('/images/hero-bg.png')" }}
      >
        <div className="absolute inset-0 bg-black/85 z-0"></div>

        <div className="relative z-10 flex flex-col items-center max-w-[900px]">
          <h1 className="andrea text-[length:var(--fs-h1)] text-white mb-[calc(var(--space-20)*-1)] tracking-wide">
            Privacy
          </h1>
          <h2 className="valturin text-[length:var(--fs-h2)] text-gold uppercase tracking-[4px] leading-tight">
            Policy
          </h2>
          <p className="gotham text-[length:var(--fs-body)] leading-relaxed text-gray-300 font-light mt-[var(--space-32)] max-w-[750px]">
      ...
      <section className="py-[var(--space-section-y)] px-[var(--space-section-x)] bg-[#151515] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto flex flex-col gap-[var(--space-64)]">
          {/* Section 1 */}
          <div className="flex flex-col gap-[var(--space-24)]">
            <div className="flex items-center gap-[var(--space-24)]">
              ...
              <h3 className="valturin text-[length:var(--fs-h3)] text-white">
                Information We Collect
              </h3>
            </div>
            <div className="pl-[var(--space-72)]">
              <p className="gotham text-[length:var(--fs-body)] leading-[1.8] text-white font-light mb-[var(--space-16)]">
              ...
              <ul className="gotham text-[length:var(--fs-body)] leading-[1.9] text-white font-light list-disc pl-[var(--space-24)] flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-[var(--space-24)]">
            ...
            <div className="pl-[var(--space-72)]">
              <p className="gotham text-[length:var(--fs-body)] leading-[1.8] text-white font-light">
          ...
          <div className="flex flex-col gap-[var(--space-24)]">
            ...
            <div className="pl-[var(--space-72)]">
              ...
              <p className="gotham text-[length:var(--fs-body)] leading-[1.8] text-white font-light mt-[var(--space-16)]">
          ...
          <div className="flex flex-col gap-[var(--space-24)]">
            ...
            <div className="pl-[var(--space-72)]">
              ...
              <div className="flex flex-col gap-2">
                <p className="gotham text-[length:var(--fs-body)] text-gray-300 font-light">
          ...
          {/* Last Updated */}
          <div className="w-full h-[1px] bg-white/10 mt-[var(--space-32)]"></div>
