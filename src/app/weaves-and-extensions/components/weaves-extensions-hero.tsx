...
export default function WeavesExtensionsHero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center flex flex-col items-center px-6">
        ...
        >
          Elevate your look with our premium weave and extension services —
          expertly installed for seamless length, volume, and versatility.
        </p>
      </div>
    </section>
  );
