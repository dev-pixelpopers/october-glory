...
export default function Header({ theme = "light", bg = "transparent" }: { theme?: "light" | "dark"; bg?: "white" | "transparent" }) {
  ...
  return (
    <>
      ...
      <section className="bg-[#000] py-0 md:py-[clamp(3px,2.76px_+_0.065vw,4px)]">
        <div className="container mx-auto">
          <p className="text-center gotham text-[length:clamp(16px,15.03px_+_0.259vw,20px)] text-white head-note">
      ...
      <header className="w-full bg-transparent relative overflow-hidden z-50">
        ...
        <div ref={rowRef} className="w-full px-[clamp(24px,0.7px_+_6.214vw,120px)] py-[clamp(6px,5.03px_+_0.259vw,10px)] grid grid-cols-3 items-center relative z-10">
          ...
          <div className="flex justify-start" aria-hidden="true">
            <div className="h-[clamp(44px,43.03px_+_0.259vw,48px)]" />
          </div>
          ...
          <div className="flex justify-center z-10">
            <a href="/" className="flex justify-center">
              <img
                ...
                className={`site-logo h-full w-full max-w-[50%] object-contain transition-all duration-500 ${isMenuOpen || theme === 'dark' ? 'brightness-0 invert' : ''}`}
              />
            </a>
          </div>
      ...
      {/* The only copy of the menu toggle and the icons. Pinned at the position
          ...
          exactly on top of the menu button that opened it. */}
      <div
        className="fix-head fixed left-0 w-full px-[clamp(24px,0.7px_+_6.214vw,120px)] flex items-center justify-between pointer-events-none z-[10001]"
        style={{ top: controlsTop }}
      >
        <div className="pointer-events-auto">
          <button
            onClick={() => setIsMenuOpen(!isMenuOpen)}
            className={`flex items-center gap-[clamp(10px,8.54px_+_0.389vw,16px)] transition-colors group cursor-pointer ${isMenuOpen
          ...
          >
            {isMenuOpen ? (
              ...
              <div className="flex flex-col gap-[clamp(4px,3.51px_+_0.13vw,6px)] w-[clamp(24px,20.12px_+_1.036vw,40px)]">
                <span className="w-full h-[2px] bg-current transition-all"></span>
                <span className="w-full h-[2px] bg-current transition-all -ml-[clamp(6px,5.03px_+_0.259vw,10px)]"></span>
                <span className="w-full h-[2px] bg-current transition-all"></span>
              </div>
            )}
        ...
        <div className="flex items-center gap-[clamp(10px,8.54px_+_0.389vw,16px)] pointer-events-auto right-flo-icons">

            {/* Heart Icon Button */}
            <button className={`flo-icon w-[clamp(44px,43.03px_+_0.259vw,48px)] h-[clamp(44px,43.03px_+_0.259vw,48px)] rounded-full border flex items-center justify-center transition-all duration-300 bg-[#00000011] backdrop-blur-[2px] p-[clamp(6px,5.52px_+_0.13vw,8px)] ${isMenuOpen
              ? 'border-white/50 text-white hover:bg-white/10'
              : 'border-[#cba660]/60 text-[#cba660] hover:bg-[#cba660] hover:text-white hover:border-[#cba660]'
              }`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[clamp(27px,25.79px_+_0.324vw,32px)] h-[clamp(27px,25.79px_+_0.324vw,32px)]">
            ...
            <button className={`flo-icon w-[clamp(44px,43.03px_+_0.259vw,48px)] h-[clamp(44px,43.03px_+_0.259vw,48px)] rounded-full border flex items-center justify-center transition-all duration-300 bg-[#00000011] backdrop-blur-[2px] relative p-[clamp(6px,5.52px_+_0.13vw,8px)] ${isMenuOpen
              ? 'border-white/50 text-white hover:bg-white/10'
              : 'border-[#cba660]/60 text-[#cba660] hover:bg-[#cba660] hover:text-white hover:border-[#cba660]'
              }`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[clamp(27px,25.79px_+_0.324vw,32px)] h-[clamp(27px,25.79px_+_0.324vw,32px)]">
            ...
            <a href="/login" className={`flo-icon w-[clamp(44px,43.03px_+_0.259vw,48px)] h-[clamp(44px,43.03px_+_0.259vw,48px)] rounded-full border flex items-center justify-center transition-all duration-300 bg-[#00000011] backdrop-blur-[2px] p-[clamp(6px,5.52px_+_0.13vw,8px)] ${isMenuOpen
              ? 'border-white/50 text-white hover:bg-white/10'
              : 'border-[#cba660]/60 text-[#cba660] hover:bg-[#cba660] hover:text-white hover:border-[#cba660]'
              }`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[clamp(27px,25.79px_+_0.324vw,32px)] h-[clamp(27px,25.79px_+_0.324vw,32px)]">
