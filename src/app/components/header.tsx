      ...
      <header className="w-full bg-transparent relative overflow-hidden z-50">
        ...
        <div className="w-full px-[120px] py-[10px] grid grid-cols-3 items-center relative z-10">
          ...
          <div className="flex justify-end items-center gap-3 md:gap-4">
            {/* Heart Icon Button */}
            <button className={`w-13 h-13 rounded-full border flex items-center justify-center transition-all duration-300 p-2 ${isMenuOpen
            ...
            <button className={`w-13 h-13 rounded-full border flex items-center justify-center transition-all duration-300 relative p-2 ${isMenuOpen
              ? 'border-white/50 text-white hover:bg-white/10'
              : theme === 'dark'
                ? 'border-white/30 text-white hover:bg-[#cba660] hover:border-[#cba660]'
                : 'border-gray-500 text-gray-800 hover:text-white hover:bg-[#cba660] hover:border-[#cba660]'
            ...
            <a href="/login" className={`w-13 h-13 rounded-full border flex items-center justify-center transition-all duration-300 p-2 ${isMenuOpen
              ? 'border-white/50 text-white hover:bg-white/10'
              : theme === 'dark'
                ? 'border-white/30 text-white hover:bg-[#cba660] hover:border-[#cba660]'
                : 'border-gray-500 text-gray-800 hover:text-white hover:bg-[#cba660] hover:border-[#cba660]'
